...
class ConfigFinder():
    def __init__(self, agentName):
        self.agentName = AGENT_CONFIG_FILENAMES[agentName]
    ...
    def get_path(self):
        ...
        if system == "windows":
            ...
            potential_paths = [
                os.path.join(appdata, "Claude", config_filename),
                os.path.join(localappdata, "Claude", config_filename),
                os.path.join(userprofile, "AppData", "Roaming", "Claude", config_filename),
                os.path.join(userprofile, "AppData", "Local", "Claude", config_filename),
                os.path.join(userprofile, ".claude", config_filename),
            ...
            potential_paths = [
                os.path.join(home, "Library", "Application Support", "Claude", config_filename),
                os.path.join(home, "Library", "Preferences", "Claude", config_filename),
                os.path.join(home, ".claude", config_filename),
                os.path.join(home, ".config", "claude", config_filename),
            ...
            potential_paths = [
                os.path.join(xdg_config, "claude", config_filename),
                os.path.join(home, ".claude", config_filename),
                os.path.join(home, ".config", "claude", config_filename),
                os.path.join(home, config_filename),
                os.path.join("/etc", "claude", config_filename),
            ]
